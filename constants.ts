...
import { BrainCircuit, Cpu, Code, Users, BarChart, Mic, Linkedin, Github, Mail, Download, ExternalLink, Network, Shield, Server, Database, Cloud, Monitor, Clock, MessageSquare, CodeXml, GitBranch, Waypoints, Briefcase, GraduationCap } from 'lucide-react';
